...
| Writing Guide skill (Dia) | `claude-contexts/writing-guide.md` | Voice and tone rules, three output streams (Universal Guide, Recency Feed, Newsletter), six content types with templates (Action Required, What's New, Policy Update, Concept, Reference, Playbook), four persona writing angles (Partnerships & Alliances, Sales AEs, Finance & Deal Desk, Sales Operations & Biz Tech), 101/201 maturity levels, formatting rules, quality checklist. |
